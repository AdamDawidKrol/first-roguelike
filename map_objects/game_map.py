        ...
        for i in range(number_of_monsters):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                if randint(0, 100) < 80:
                    ...
                    monster = Entity(x, y, 'o', libtcod.desaturated_green, 'Orc', blocks = True, fighter = orc, ai = ai_component, render_order = RenderOrder.ACTOR)
                else:
                    troll = Fighter(30, 3, 10)
                    ai_component = BasicMonster()
                    
                    monster = Entity(x, y, 'T', libtcod.darker_green, 'Troll', blocks = True, fighter = troll, ai = ai_component, render_order = RenderOrder.ACTOR)
